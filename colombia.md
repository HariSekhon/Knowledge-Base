...
An exit flight is required before airlines will let you check-in (Copa airlines enforced this),
similar with many other latin american countries.
...
- [Chef Burger](https://maps.app.goo.gl/sM3jmyHw7YZAXTuU8) - Medellin-based chain that has a few branches in Bogota and
  one in Cali too.
...
if you've missed that before customs as they have a sign that tickets are \$17
and it seems you can pay in dollars or local currency.
It appears some people paid in cash upon arrival to Medellin,
while others like me gave their prepaid ticket to the driver.

I then used an Uber for the last 2km for a mere £3,
which was an official small yellow taxi hatchback that worked out cheaper than the other options on Uber, but
