...
[![Birthrate Per Woman](https://ourworldindata.org/grapher/children-per-woman-un.svg?tab=line&country=~ARG~AFG~CAF~CMR~COD~COG~MOZ~NER~NGA~SDN~TCD~UGA)](https://ourworldindata.org/grapher/children-per-woman-un?tab=line&country=~ARG)
...
which can be purchased using contactless card payment at the _"Open 25 hs"_ store just inside the door next to
the [bus stop](https://maps.app.goo.gl/SQ7ZnZVqzjSwtQE96).

The card itself costs 1,500 ($1.50), plus whatever credit you choose to add to it -
I added 1,500 just to cover the one journey.

Make sure you confirm the destination with the bus driver as it turns out there are actually 3 _"number 8"_buses and
