...
[![Birthrate Per Woman](https://ourworldindata.org/grapher/children-per-woman-un.svg?tab=line&country=~CHL~AFG~CAF~CMR~COD~COG~MOZ~NER~NGA~SDN~TCD~UGA)](https://ourworldindata.org/grapher/children-per-woman-un?tab=line&country=~CHL)
...
- [Parque Bustamante](https://maps.app.goo.gl/oTev8xFi1KYTjtQZ6) - good sized city park with lots of trees,
  ...
  - [All Boxing](https://maps.app.goo.gl/tfWmqFfJD7mmmzHr8) - 2-3 mins walk east of the centre of the park
- [Parque Metropolitano de Santiago](https://maps.app.goo.gl/NdFFUFeZCfYzKZ7s8) - TODO: didn't find time to make it up
  ...
  - [National Zoo](https://maps.app.goo.gl/8DC2uXYThsDL88ze6)
...
- [Taquería TH](https://maps.app.goo.gl/LzJLVLeQQ9pWt8nPA) - I wouldn't travel out of my way to this one but it is
  ...
  The chilaquiles for 9000 CLP while I scoffed it all,
  was not as good as I've had at other places primarily because the nachos themselves were a bit stale and not fresh,
...
- [Tienda koko](https://maps.app.goo.gl/4LxNVZe1E5oLECri9) - smaller grocery near
  ...
  only use this late night if Express de Lider Seminario is already closed (at 21:30), as it's eggs weren't as fresh
