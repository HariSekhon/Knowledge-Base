...
| `pandoc`                              | Universal document converter (eg. use it to [reformat script generated GitHub Markdown](helm.md#repos) (see the code commented out in the raw markdown)                                                         |
